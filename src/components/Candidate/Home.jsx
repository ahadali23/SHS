...
const FeaturedCompanies = () => (
  <Paper sx={{ p: 3 }}>
    ...
    <Grid container spacing={2}>
      <Grid item xs={12} md={4}>
        <CompanyCard name="Herman-Carter" vacancies={21} />
      </Grid>
      <Grid item xs={12} md={4}>
        <CompanyCard name="Funk Inc." vacancies={21} />
      </Grid>
      <Grid item xs={12} md={4}>
        <CompanyCard name="Williamson Inc." vacancies={21} />
      </Grid>
    </Grid>
  </Paper>
);

const CompanyCard = ({ name, vacancies }) => (
  <Box sx={{ p: 2, border: "1px solid #ccc", borderRadius: 2 }}>
